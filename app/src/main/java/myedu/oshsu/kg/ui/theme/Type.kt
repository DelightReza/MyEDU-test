 ...
 * 
 * MD3 defines 5 type scales with 3 sizes each:
 * - Display: Large, prominent text
 * - Headline: High-emphasis text
 * - Title: Medium-emphasis text
 * - Body: Main content text
 * - Label: UI text (buttons, tabs)
 */
val AppTypography = Typography(
    // DISPLAY STYLES - Largest text, used sparingly for short, important text
    ...
    // LABEL STYLES - Utility text for components
